...
public class TestProprietarioAutomobile {
	...
	private static void testInserisciUnAutomobile(AutomobileService automobileService) throws Exception {
		...
		Automobile nuovaAutomobile = new Automobile("BMW", "E36", "FF564GH",
				new SimpleDateFormat("yyyy/MM/dd").parse("1997/05/03"));
	...
	/*
	 * nel testRimuoviAutomobile viene provato anche il funzionamento del metodo
	 * caricaSingolaAutomobile, ho pensato non ci fosse bisogno di fare un test a
	 * parte
	 */
	...
	private static void testInserisciUnProprietario(ProprietarioService proprietarioService) throws Exception {
		...
		Proprietario nuovoProprietario = new Proprietario("Marco", "Rossi", "codiceFiscaleMarcoRossi",
				new SimpleDateFormat("yyyy/MM/dd").parse("1980/01/01"));
	...
	/*
	 * nel testRimuoviProprietario viene provato anche il funzionamento del metodo
	 * caricaSingolaProprietario, ho pensato non ci fosse bisogno di fare un test a
	 * parte
	 */
	private static void testRimuoviProprietario(ProprietarioService proprietarioService) throws Exception {
		...
		Proprietario nuovoProprietario = new Proprietario("Luigi", "Bianchi", "codiceFiscaleLuigiBianchi",
				new SimpleDateFormat("yyyy/MM/dd").parse("1990/04/12"));
		if (nuovoProprietario.getId() != null)
	...
	private static void testContaQuantiProprietarisiedonoAutomobiliImmatricolateDopo(
		...
		System.out.println(
				".......testContaQuantiProprietarisiedonoAutomobiliImmatricolateDopo fine: PASSED.............");
	}

	private static void testCercaTutteAutomobiliConProprietarioConCodiceFiscaleCheIniziaCon(
			ProprietarioService proprietarioService, AutomobileService automobileService) throws Exception {
		System.out.println(
				".......testCercaTutteAutomobiliConProprietarioConCodiceFiscaleCheIniziaCon inizio.............");

		Automobile nuovaAutomobile = new Automobile("Fiat", "punto", "FF564GH",
				new SimpleDateFormat("yyyy/MM/dd").parse("1997/05/03"));
		Automobile nuovaAutomobile2 = new Automobile("Fiat", "panda", "FF564GH",
				new SimpleDateFormat("yyyy/MM/dd").parse("1997/05/03"));
		Proprietario nuovoProprietario = new Proprietario("Gigi", "Marrone", "gigiMarroneCF",
				new SimpleDateFormat("yyyy/MM/dd").parse("1980/01/01"));
		...
		System.out.println(
				".......testCercaTutteAutomobiliConProprietarioConCodiceFiscaleCheIniziaCon fine: PASSED.............");
	}

	private static void testCercaTutteAutomobiliErroriDiMinorenni(ProprietarioService proprietarioService,
		...
		Proprietario nuovoProprietario2 = new Proprietario("Gigi", "Marrone", "gigiMarroneCF",
				new SimpleDateFormat("yyyy/MM/dd").parse("2010/01/01"));
